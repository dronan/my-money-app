        ...
        <div className="login-box">
            ...
            <div className="login-box-body">
                ...
                <form onSubmit={handleSubmit(v => this.onSubmit(v))}>
                    ...
                    <Row>
                        <Grid cols="4">
                            <button type="submit" className="btn btn-primary btn-block btn-flat"> {loginMode ? 'Login' : 'Register'} </button>
                        </Grid>
                    </Row>
                </form>
                <br />
                <a onClick={() => this.changeMode()}> {loginMode ? 'New user? Register here!' : 'Already registered? Login here!'} </a>
            </div>
            <Messages />
        </div>
    )
